    ...
    sidebarLayout(
        sidebarPanel(
            ...
            conditionalPanel(
                ...
                selectInput(inputId="oscars_metric", label="Metric", choices=choices$oscars_metric, selected=choices$oscars_metric[[1]]),
            ...
            conditionalPanel(
                ...
                selectInput(inputId="actors_movies_metric", label="Metric", choices=choices$movies_metric, selected=choices$movies_metric[[1]]),
            ...
            conditionalPanel(
                ...
                selectInput(inputId="directors_movies_metric", label="Metric", choices=choices$movies_metric, selected=choices$movies_metric[[1]]),
            ...
            conditionalPanel(
                ...
                selectInput(inputId="producers_movies_metric", label="Metric", choices=choices$movies_metric, selected=choices$movies_metric[[1]]),
